...
//go:generate swagger generate server --target ../../app --name Gpg --spec ../swagger.yaml --principal interface{}

func configureFlags(api *operations.GpgAPI) {
...
func configureAPI(api *operations.GpgAPI) http.Handler {
